                                ...
                                <li class="header__navbar-item header__navbar-user">
                                    ...
                                    <ul class="header__navbar-user-menu">
                                        <!--                                            <li class="header__navbar-user-item">
                                                                                        <a href="${pageContext.request.contextPath}/ligmaShop/login/adminPage.jsp">Quản lý sản phẩm</a>
                                                                                    </li>-->
                                        <li class="header__navbar-user-item">
                            ...
                            <ul class="category-list">
                                <c:forEach items="${category}" var="o">
                                    <li class="category-item">
                                        <a href="category?cID=${o.categoryID}&page=1&query=rong" class="category-item__link ${param.cID == o.categoryID ? 'selected' : ''}">${o.categoryName}</a>
                                    </li>
                                </c:forEach>
                            </ul>
                                ...
                                <ul class="pagination home-product__pagination">
                                    <li class="pagination-item pagination-item--active">
                                        <c:if test="${currentPage > 1}">
                                            ...
                                            <a href="category?page=${currentPage - 1}&cID=${param.cID}&query=${param.query}" class="pagination-item__link">
                                    ...
                                    <li class="pagination-item">
                                        <c:forEach var="i" begin="1" end="${totalPages}">
                                            <a href="category?page=${i}&cID=${param.cID!=null ? param.cID:1}&query=${param.query}" class="pagination-item__link">${i}</a>
                                        </c:forEach>
                                    </li>
                                    <li class="pagination-item">
                                        <c:if test="${currentPage < totalPages}">
                                            <a href="category?page=${currentPage + 1}&cID=${param.cID!=null ? param.cID:1}&query=${param.query}" class="pagination-item__link">
