...
<p class="p-bottom-w3ls">Forgot Password? <a href="#">Click here</a></p>
                                <p class="p-bottom-w3ls1">New User? <a href="register.jsp">Register here</a></p>
                                <div class="clear"></div>
                            ...
                            <div class="social w3layouts">
                                ...
                                <div class="icons">
                                    ...
                                    <a  href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/LigmaBallsOfficial/logingg&response_type=code&client_id=104499240705-951rk6sn3o4g8cbj0kmf8toc06i934ln.apps.googleusercontent...pt=force">
