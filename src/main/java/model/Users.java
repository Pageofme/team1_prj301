...
public class Users implements Serializable
{
    ...
    private Collection<Chatsessions> chatsessionsCollection;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "userID")
    ...
    @XmlTransient
    public Collection<Chatsessions> getChatsessionsCollection()
    {
        return chatsessionsCollection;
    }

    public void setChatsessionsCollection(Collection<Chatsessions> chatsessionsCollection)
    {
        this.chatsessionsCollection = chatsessionsCollection;
    }
