...
gulp.task('buildOptionalVendorScripts', function() {
    ...
    var aScript42 = gulp.src(['../node_modules/codemirror/mode/shell/shell.js'])
        .pipe(gulp.dest('./vendors/codemirror'));
    var aScript23 = gulp.src(['../node_modules/pwstabs/jquery.pwstabs.min.js'])
...
gulp.task('buildOptionalVendorStyles', function() {
    ...
    var fonts = gulp.src(['./fonts/fonts/*'])
        .pipe(gulp.dest('./vendors/bootstrap-datepicker/fonts'))
    ...
    var aStyle37 = gulp.src(['../node_modules/codemirror/theme/ambiance.css'])
        .pipe(gulp.dest('./vendors/codemirror'));
    var aStyle54 = gulp.src(['../node_modules/pwstabs/jquery.pwstabs.min.css'])
        .pipe(gulp.dest('./vendors/pwstabs'));
