...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/styleProductDetails.css">
        <script src="${pageContext.request.contextPath}/js/productDetails.js"></script>
