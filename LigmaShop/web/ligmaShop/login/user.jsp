                        ...
                        <div class="col l-10 m-12 c-12">
                            ...
                            <div class="home-product">
                                <div class="row sm-gutter">
                                        ...
                                        <c:if test="${status.index >= start && status.index < start + pageSize}">
                                            ...
                                            <div class="col l-2-4 m-4 c-6">
                                                <div class="home-product-item">
                                                    ...
                                                    <div class="home-product-item__buttons">
                                                        <a href="editProduct?id=${product.id}" class="edit-btn">Sửa</a>
                                                        <a href="deleteProduct?id=${product.id}" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này?')" class="delete-btn">Xóa</a>
                                                    </div>
                                    ...
                                    <script src="${pageContext.request.contextPath}/js/jsDeleteEditPRD.js"></script>
                                    ...
                                    <ul class="pagination home-product__pagination">
                                        ...
                                        <li class="pagination-item">
                                            <c:if test="${currentPage > 1}">
                                                <a href="${pageContext.request.contextPath}/products?page=${currentPage - 1}" class="pagination-item__link pagination-arrow">
                                        ...
                                        <c:forEach var="i" begin="1" end="${totalPages}">
                                            <li class="pagination-item">
                                                <a href="${pageContext.request.contextPath}/products?page=${i}" class="pagination-item__link ${i == currentPage ? 'active-page' : ''}">${i}</a>
                                            </li>
                                        </c:forEach>
